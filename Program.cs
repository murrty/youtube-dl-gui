    ...
    static class Program {
        ...
        static void Main() {
            ...
            if (Properties.Settings.Default.firstTime) {
                if (MessageBox.Show("youtube-dl-gui is a visual extension to youtube-dl and is not affiliated with them in any way.\n\nThis program (and I) does not condone piracy or illegally downloading of any video you do not own the rights to or is not in public domain.\n\nAny help regarding any problems when downloading anything illegal (in my jurisdiction) will be ignored. Click no if you agree.\n\nHave you read the above?", "youtube-dl-gui", MessageBoxButtons.YesNo) == DialogResult.No) {
