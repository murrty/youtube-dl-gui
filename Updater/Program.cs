...
namespace youtube_dl_gui_updater {
    class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine("*=========================*\n");
            Console.WriteLine("FriendlyName is " + ytdlExec + " which youtube-dl-gui will be named");

            if (dontUpdate) {
                /// This is a debug argument
            ...
            if (System.IO.File.Exists(Environment.CurrentDirectory + "\\youtube-dl-gui.exe.part")) {
                Console.WriteLine("youtube-dl-gui.exe.part exists, assuming it's the new version...");
                ...
                System.IO.File.Move(Environment.CurrentDirectory + "\\youtube-dl-gui.exe.part", Environment.CurrentDirectory + "\\" + ytdlExec);
